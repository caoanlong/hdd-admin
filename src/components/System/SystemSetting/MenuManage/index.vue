	...
	<div class="main-content">
		<el-card class="box-card">
			...
			<div class="tableControl">
				...
				<el-button type="default" size="mini"><svg-icon icon-class="save_icon"></svg-icon> 保存排序</el-button>
			...
			<div class="table">
				<el-table :data="tableData" border style="width: 100%" size="mini">
					...
					<el-table-column  label="组件" prop="url"></el-table-column>
					<el-table-column  label="排序" prop="sort" width="120" align="center"></el-table-column>
					<el-table-column  label="可见" prop="visibility" width="120" align="center"></el-table-column>
					<el-table-column  label="权限标识"></el-table-column>
